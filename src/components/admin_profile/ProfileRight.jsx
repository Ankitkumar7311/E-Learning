...
import RequestReport from "./RequestReport";  // ✅ import new component
...
let ProfileRight = () => {
  ...
  const features = [
    ...
    { img: requestImg, p: "Request/Report", component: <RequestReport /> }, // ✅ added component
    { img: editImg, p: "Edit Material" , component:<EditMaterial/>}
  ];

  const uploads = [
    { title: "Upload PYQ", label: "PYQ", component: <UploadPYQ /> },
    { title: "Upload Notes", label: "Notes", component: <UploadNotes /> },
    { title: "Upload QB", label: "QB", component: <UploadQB /> },
        ...
        >
          {features.map((items, index) => (
            <div
              ...
              onClick={() => items.component && setModalContent(items.component)} // ✅ open only if component exists
            >
