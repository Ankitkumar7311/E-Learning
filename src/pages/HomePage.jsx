...
//         {/* --- FOOTER: MODIFIED FOR RESPONSIVENESS --- */}
//         <footer className="min-w-2xl text-center text-gray-500 py-6 px-4">
//           <p className="font-semibold text-base">Developed by:</p>
//           <p className="text-sm mb-2">CSD (2022-2026)</p>
//           <ul className="flex flex-col md:flex-row justify-center items-center gap-1 md:gap-4 uppercase text-sm">
//             <li>Avula UdayKiran</li>
//             <li>Babburu Amulya</li>
//             <li>Bejju RiteshVardhan</li>
//             <li>Bathula Akhil kumar Yadav</li>
//             <li>D.Vaishnavi</li>
//           </ul>
//         </footer>
//         {/* --- END OF FOOTER --- */}
