...
// // import curveBg from "../assets/Curve.png";
// // import card from "../assets/card.png";
// // import { useAuth } from "../context/AuthContext"; // Ensure path to your new context is correct
...
// //     try {
// //       // ONE function call now handles everything!
...
// //           facultyId: finalAuthState.user.facultyId,
// //         },
// //       });
...
//       navigate('/teacher/dashboard', { state: { facultyId: user.facultyId || user.id, email: user.email } });
//     } catch (err) {
//       console.error('Login Error:', err);
//       setError(err.message || 'An unexpected error occurred during login.');
//     } finally {
...
//   return (
//     <section className="w-full min-h-screen flex items-center justify-center bg-no-repeat bg-cover px-4" style={{ backgroundImage: `url(${curveBg})` }}>
//       {/* Put your teacher login form UI here. Keep form onSubmit={handleSubmit(onSubmit)} and inputs registered like in Login.jsx */}
//       <div>Teacher login form (copy your existing JSX and wire to handleSubmit/onSubmit)</div>
//     </section>
//   );
// };
...
const TeacherLogin = () => {
  ...
  return (
    <section className="w-full min-h-screen flex items-center justify-center bg-no-repeat bg-cover px-4" style={{ backgroundImage: `url(${curveBg})` }}>
      {/* Teacher Login Form UI - Replace this placeholder with your actual form JSX */}
      <div 
      ...
      >
        <h1 className="text-xl md:text-3xl font-medium mb-2 text-center">Teacher LogIn</h1>
