...
const TeacherNavBar = () => {
 ...
 const pageTitles = {
  // FIX 2: Corrected all keys to be absolute paths starting from /teacher
  "/teacher/update-profile": "Update Profile",
  "/teacher/dashboard": "Faculty Panel",
  "/teacher/request-report": "Report / Request", // ✅ Corrected path
  "/teacher/edit-material": "Edit Material", // ✅ Corrected path
  "/teacher/help-support": "Help & Support", // ✅ Added for clarity
 };
 ...
 const MenuItems = ({ isMobile = false }) => (
  ...
  >
   ...
   <Link
    to="/teacher/help-support" // ✅ Mobile link is correct
   ...
   <nav className="sticky top-0 z-30 bg-white/95 shadow-lg backdrop-blur-sm">
    ...
    <div className="mx-auto flex max-w-7xl items-center justify-between px-4 py-3 sm:px-6">
     ...
     <div className="hidden items-center space-x-8 lg:flex">
      <Link
       to="/teacher/help-support" // FIX 1: Corrected desktop link path
