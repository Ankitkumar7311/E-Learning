          ...
          <div className="space-y-4">
            ...
            <div className="grid grid-cols-1 md:grid-cols-4 gap-4 items-end">
              <select
                ...
                className="w-full px-4 py-2 border border-gray-300  shadow-sm focus:outline-none focus:ring-2 focus:ring-blue-500 rounded-lg inset-shadow-sm inset-shadow-indigo-500  hover:bg-blue-200 bg-[#D8E7F5]  "
              >
              ...
              <select
                ...
                className="w-full px-4 py-2 border border-gray-300 rounded-lg shadow-sm focus:outline-none focus:ring-2 focus:ring-blue-500  inset-shadow-sm inset-shadow-indigo-500  hover:bg-blue-200 bg-[#D8E7F5] "
              >
