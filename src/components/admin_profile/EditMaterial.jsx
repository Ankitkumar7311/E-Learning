    ...
    <div className="min-h-screen bg-gray-50 font-sans">
      ...
      <header className="flex items-center justify-between px-8 py-4 bg-white shadow-md">
        <div className="flex items-center space-x-4">
          ...
          <a href="#">
            <span className="bg-blue-200 border border-slate-300 text-slate-700 font-semibold px-8 py-2.5 rounded-full hover:bg-blue-300 hover:text-white ml-[50px]">
              Faculty
            </span>
          </a>
        </div>
      ...
      <main className="container mx-auto px-4 py-12 flex flex-col items-center space-y-8">
        {!showEdit ? (
          ...
          // Show Editmaterialedit component when Edit is clicked
          <Editmaterialedit />
        )}
      </main>
    </div>
