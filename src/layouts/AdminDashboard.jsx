...
const ActionButton = ({ icon, text, onClick }) => (
  <button
    onClick={onClick}
    className="flex flex-row sm:flex-col items-center sm:items-center justify-start sm:justify-center p-4 sm:p-6 bg-blue-100 hover:bg-blue-200 rounded-2xl shadow-md transition duration-300 focus:outline-none focus:ring-2 focus:ring-blue-500 focus:ring-opacity-50"
  >
    <div className="mr-4 sm:mb-4 bg-yellow-400 p-3 sm:p-4 rounded-xl shadow">
      {icon}
    </div>
