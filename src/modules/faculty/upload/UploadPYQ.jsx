...
const UploadPYQ = () => {
  ...
  // --- Data Fetching Effects (largely unchanged) ---
  useEffect(() => {
    let cancelled = false;
  ...
  // --- Render Info ---
  const BRANCHES = ["CSE", "CIVIL", "EEE", "MECH", "ECE"];
  ...
  return (
    <div>
      ...
      <h2 className="text-2xl md:text-3xl font-extrabold text-gray-800 mb-6 border-b pb-3 text-blue-800">Upload Previous Year Questions (PYQ)</h2>
      ...
      <form onSubmit={handleSubmit} className="space-y-6">
          ...
          <div className="pt-4">
            ...
            <div className="flex flex-col gap-5">
              ...
              <div className="flex justify-end mt-2">
                <button type="button" onClick={addUnit} className="bg-blue-100 hover:bg-green-400 text-green-800 font-bold py-2 px-6 rounded-lg transition">
                 + Add Unit
                </button>
              </div>
            </div>
        ...
        <div className="flex justify-center pt-4">
          ...
          >
            {isUploading ? "Uploading..." : "Submit PYQs"}
          </button>
        </div>
      </form>
    </div>
